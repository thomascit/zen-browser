<h3 align="center">
	🧛 Dracula for <a href="https://zen-browser.app/">Zen Browser</a>
</h3>

<p align="center">
	A dark theme for Zen Browser using the <a href="https://draculatheme.com/">Dracula</a> color palette.
</p>
...
- **Q:** What if I already have a `userChrome.css` and/or `userContent.css` configuration?
  ...
  **A:** You can copy and paste the content of the `userChrome.css` and/or `userContent.css` files into your existing ones. This way, you can keep your current configurations while applying the new theme settings.
...
<p align="center">
	Based on work copyright &copy; 2021-present <a href="https://github.com/catppuccin" target="_blank">Catppuccin Org</a>, licensed under <a href="LICENSE">MIT</a>.
</p>
